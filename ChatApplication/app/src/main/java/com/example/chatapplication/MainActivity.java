            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Text 값 받아서 로그 남기기
                        final String friend_email = email_editText.getText().toString().trim();

                        firebaseFirestore.collection("users").document(friend_email).get()
                                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if(task.isSuccessful()){ //입력한 이메일 정보의 유저가 존재하는 경우
                                            ...
                                            data.put("nickname", friend.getNickname());
                                            data.put("profileUri", friend.getProfile_uri());
                                        ...
                                        Fragment ft = getSupportFragmentManager().findFragmentById(R.id.mainLayout);
                                        getSupportFragmentManager().beginTransaction().detach(ft).attach(ft).commit();
                                    }
                                });
